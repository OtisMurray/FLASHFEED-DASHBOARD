...
const NAV = [
  ...
  { href: '/charts-grid', label: 'Charts Grid', icon: '⊞' },
    ...
    <>
      <aside className="w-[220px] bg-surface border-r border-border flex-shrink-0 flex flex-col">
        ...
        <div className="border-t border-border p-2 space-y-0.5">
          ...
          <NavLink to="/settings" className="flex items-center gap-3 px-4 py-2 text-sm text-neutral hover:text-white hover:bg-slate-800 rounded transition-colors">
